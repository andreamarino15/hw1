    ...
    <body>
        <header id="header">
            ...
            <div id="input">
                ...
                <form id="searchForm" autocomplete="off" method="GET" action="risultati_index.php">
                    <div id="search">
            ...
            <nav id="navbar">
                ...
                <a href="https://stockx.com/sell">
                    Sell</a>
                <a>
                    <svg id="notification" class="stockx-icon" focusable="false" viewBox="0 0 50 50" aria-hidden="true">
                        <path d="M28.7998 39.1C28.7998 41.3 26.9998 43.1 24.7998 43.1C22.5998 43.1 20.7998 41.3 20.7998 39.1H28.7998Z" fill="currentColor">
                        </path>
                        <path d="M25.988 6.99458L23.688 7.00537L23.7129 12.3054L26.0129 12.2946L25.988 6.99458Z" fill="currentColor">
                        </path>
                        <path d="M35.4 26.1C34.6 26 33.8 25.8 33.1 25.4C33.3 28 33.8 31.8 35.4 34.5H14.2C16.9 30 16.7 22.9 16.7 22.6C16.7 17.5 20.4 13.3 24.9 13.3C26.6 13.3 28.2 13.9 29.5 14.9C29.8 14.2 30.3 13.6 30.8 13.1C29.1 11.8 27.1 11.1 24.9 11.1C19.2 11.1 14.5 16.3 14.5 22.7C14.5 22.8 14.8 31.6 11.2 34.8L9 36.8H41.3L38.7 34.8C36.5 33.3 35.7 29.3 35.4 26.1Z" fill="currentColor">
                        </path>
                        <path d="M36.3999 24C39.4375 24 41.8999 21.5376 41.8999 18.5C41.8999 15.4624 39.4375 13 36.3999 13C33.3623 13 30.8999 15.4624 30.8999 18.5C30.8999 21.5376 33.3623 24 36.3999 24Z" fill="var(--chakra-colors-brand-primary)">
                        </path>
                        <path d="M36.3999 13C39.3999 13 41.8999 15.5 41.8999 18.5C41.8999 21.5 39.3999 24 36.3999 24C33.3999 24 30.8999 21.5 30.8999 18.5C30.8999 15.5 33.3999 13 36.3999 13Z" fill="var(--chakra-colors-brand-primary)">
                        </path>
                    </svg>
        ...
        <div id="hidden_notification" class="hidden">
            ...
            <div id="section_notification">
                <div>
                    <p>
                        Login or sign up to get notifications about your orders and the products you're following.
                    </p>
                </div>
            </div>
            <footer id="footer_notification">
                <li>
                    <a href="login.php">
                        <button id="login">
                            Login
