...
$username = $_SESSION['_agora_username'] ?? 'Utente';
?>
...
<head>
    ...
    <script src="profilo.js?v=<?php echo time(); ?>" defer></script>
</head>
...
<body>
    ...
    <div id="container">
        <header>
            <h1>Il Mio Profilo: "<?php echo htmlspecialchars($username); ?>"</h1>
            <p>Gestisci i tuoi articoli preferiti</p>
        </header>
