...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Big+Shoulders+Stencil:opsz,wght@10..72,100..900&family=Tektur:wght@400..900&display=swap"
        rel="stylesheet">
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=search" />
    <meta charset="UTF-8" />
    <title>Risultati ricerca</title>
    <link rel="stylesheet" href="risultati.css?v=<?php echo time(); ?>">
    <script src="risultati.js?v=<?php echo time(); ?>" defer></script>
</head>
...
<body>
    ...
    <header id="header">
        <div id="hidden">
            <button id="menu_hidden">
                <svg class="stockx-icon " focusable="false" viewBox="0 0 50 50"
                    style="fill: var(--chakra-colors-text-primary, text-primary);">
                    <g>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7 16.25V14H43V16.25H7Z"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M43 26.5H7V24.25H43V26.5Z"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M43 36.75H7V34.5H43V36.75Z"></path>
                    </g>
                </svg>
            </button>
            <div id="logo_hidden">
                <a href="hw1.php">
                    <svg class="stockx-icon " focusable="false" viewBox="0 0 201 40" aria-hidden="true"
                        style="fill: var(--chakra-colors-brand-primary, brand-primary);">
                        <title>StockX Logo</title>
                        <g>
                            <path
                                d="M186.401 27.5001L201.001 40V30L189.328 20.0056L201.001 10V0L180.601 17.4859V12.4999L166.001 0V10L177.674 19.9944L166.001 30V40L186.401 22.5144V27.5001Z">
                            </path>
                            <path
                                d="M20.3007 16.8L13.7506 15.55C10.1005 14.85 8.50062 14 8.50062 12C8.50062 9.19995 11.6506 7.74994 15.6006 7.74994C19.7506 7.74994 23.4506 9.34994 24.2506 12.75H31.2508C30.4508 6.25002 24.6007 2 15.6006 2C7.30062 2 0.750616 5.65011 0.750616 12.2501C0.750616 18.0001 5.65063 20.9001 12.2006 22.1501L18.7506 23.4001C22.4007 24.1001 24.2506 25.2501 24.2506 27.5001C24.2506 30.55 20.8506 32.2501 16.6506 32.2501C11.5006 32.2501 8.05063 29.7501 7.25063 26.0001H0.000610352C1.0506 33.5001 6.95062 38.0001 16.6506 38.0001C25.3006 38.0001 32.0006 34.5001 32.0006 27.25C32.0007 20.85 26.8506 18.05 20.3007 16.8Z">
                            </path>
                            <path
                                d="M48.6507 6.25001V2.5H41.4007V5.25001C41.4007 8.49998 39.9007 10 36.6507 10H34.6007V15.5H40.3507V29.0001C40.3507 35.0001 43.3007 37.5001 50.3007 37.5001H56.2507V32H50.9507C48.4507 32 47.6007 31.25 47.6007 29V15.5H56.2507V10H45.5007L48.6507 6.25001Z">
                            </path>
                            <path
                                d="M111.351 32.5C106.101 32.5 102.751 28.8 102.751 23.8C102.751 18.8 106.101 15.1 111.351 15.1C115.401 15.1 118.301 17.35 119.051 20.1H126.201C124.901 13.6 119.251 9.59998 111.351 9.59998C101.901 9.59998 95.3508 15.3 95.3508 23.8C95.3508 32.3 101.901 38 111.351 38C119.251 38 125.451 34 126.451 27.25H119.301C118.551 29.75 115.851 32.5 111.351 32.5Z">
                            </path>
                            <path
                                d="M75.3507 9.59998C65.6008 9.59998 59.3507 15.3 59.3507 23.8C59.3507 32.3 65.6007 38 75.3507 38C85.1007 38 91.3508 32.3 91.3508 23.8C91.3508 15.3 85.1008 9.59998 75.3507 9.59998ZM75.3507 32.5C70.1007 32.5 66.7507 28.8 66.7507 23.8C66.7507 18.8 70.1007 15.1 75.3507 15.1C80.6007 15.1 83.9508 18.8 83.9508 23.8C83.9508 28.8 80.6008 32.5 75.3507 32.5Z">
                            </path>
                            <path
                                d="M145.151 22.9001L160.201 10.0001H150.451L138.151 20.8001V2.5H130.901V37.5001H138.151V28.9001L142.498 25.1742L153.051 37.5001H162.251L149.751 22.9001H145.151Z">
                            </path>
                        </g>
                    </svg>
                </a>
        ...
        <div id="input">
            ...
            <form id="searchForm" autocomplete="off" method="GET" action="risultati.php">
                <div id="search">
                    <input type="text" name="search" placeholder="Search for brand, color, etc. ">
        ...
        <nav id="navbar">
            <a
                href="https://stockx.com/news/?_gl=1*1jwjrkw*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwp8--BhBREiwAj7og1zCiMJTWjOieYuqnXpdmxSbM-VC3KtJMYJRZLqwcMAGbKfA1gb52uRoCQ74QAvD_BwE&gclsrc=aw.ds">
                News</a>
            <a
                href="https://stockx.com/about/how-it-works/?_gl=1*bki2o7*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwp8--BhBREiwAj7og1zCiMJTWjOieYuqnXpdmxSbM-VC3KtJMYJRZLqwcMAGbKfA1gb52uRoCQ74QAvD_BwE&gclsrc=aw.ds">
                About</a>
            <a
                href="https://stockx.com/help/home?_gl=1*1ykamvz*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwp8--BhBREiwAj7og1zCiMJTWjOieYuqnXpdmxSbM-VC3KtJMYJRZLqwcMAGbKfA1gb52uRoCQ74QAvD_BwE&gclsrc=aw.ds">
                Help</a>
            <a href="https://stockx.com/sell">
                Sell</a>
            <a href="">
                <svg id="profile" class="stockx-icon " focusable="false" viewBox="0 0 50 50">
                    <path
                        d="M25 26.6999C19.8 26.6999 15.6 22.4999 15.6 17.2999C15.6 12.0999 19.8 7.8999 25 7.8999C30.2 7.8999 34.4 12.0999 34.4 17.2999C34.4 22.4999 30.2 26.6999 25 26.6999ZM25 10.0999C21.1 10.0999 17.8 13.2999 17.8 17.2999C17.8 21.2999 21 24.4999 25 24.4999C29 24.4999 32.2 21.2999 32.2 17.2999C32.2 13.2999 28.9 10.0999 25 10.0999Z"
                        fill="white"></path>
                    <path
                        d="M41.4 42.1998C39.6 34.6998 32.8 29.2998 25 29.2998C17.3 29.2998 10.4 34.6998 8.59998 42.1998H10.9C12.6 35.9998 18.4 31.4998 24.9 31.4998C31.4 31.4998 37.2 35.9998 38.9 42.1998H41.4Z"
                        fill="white"></path>
                </svg>
    ...
    <h1>Risultati per la ricerca:
        "<?php echo htmlspecialchars($search); // htmlspecialchars protegge da XSS e iniezioni html ?>"</h1>
    <div id="articoli"></div>
        ...
        <div id="contenitore_footer">
            ...
            <div class="elementi_footer">
                ...
                <ul>
                    ...
                    <li>
                        <a
                            href="https://stockx.com/help/articles/I-dont-know-how-an-item-fits-Can-you-make-a-size-recommendation">
                            Size Guide
                        </a>
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        <a
                            href="https://stockx.com/pop-mart-labubu-the-monsters-coca-cola-series-vinyl-face-sealed-case-6-blind-box">
                            Coca Cola Case
                        </a>
                    </li>
                    <li>
                        <a
                            href="https://stockx.com/pop-mart-labubu-the-monsters-have-a-seat-vinyl-plush-blind-box-set-of-6">
                            Have A Seat Case
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a
                            href="https://stockx.com/pop-mart-labubu-the-monsters-fall-in-wild-vinyl-plush-doll-pendant-keychain">
                            Labubu Fall in Wild
                        </a>
                    </li>
                    <li>
                        <a
                            href="https://stockx.com/pop-mart-labubu-the-monsters-tasty-macarons-vinyl-face-blind-box-whole-set">
                            Tasty Macarons Case
                        </a>
                    </li>
                </ul>
                ...
                <div id="last_container">
                    <div>
                        <a id="first_link" href="https://apps.apple.com/us/app/stockx-sneakers-and-apparel/id881599819">
                            <svg viewBox="0 0 128 43" focusable="false" class="chakra-icon css-1a9naxn">
                                <g clip-path="url(#clip0_1347_18305)">
                                    ...
                                    <path
                                        ...
                                        fill="white"></path>
                                    <path d="M63.2109 9.06976H64.1615V15.8001H63.2109V9.06976Z" fill="white"></path>
                                    <path
    ...
    <div id="ultimo_contenitore">
        <div id="primo_div">
            <div id="uno">
                <svg class="stockx-icon " focusable="false" viewBox="0 0 53 60"
                    style="fill: var(--chakra-colors-brand-primary, brand-primary);">
                    <title>StockX Logo</title>
                    <path
                        d="M30.4985 41.25L52.3257 59.9999V44.9999L34.8738 30.0083L52.3257 15V0L21.8272 26.2288V18.7499L0 0V15L17.4519 29.9916L0 44.9999V59.9999L30.4985 33.7715V41.25Z">
                    </path>
                </svg>
                <div>
                    <button>
                ...
                <ul>
                    <li>
                        <a href="https://x.com/stockx">
                            <svg class="stockx-icon " focusable="false" viewBox="0 0 1200 1227"
                                style="fill: var(--chakra-colors-text-primary, text-primary); color: var(--chakra-colors-text-primary, text-primary);">
                                <g>
                                    <path fill="currentColor"
                    ...
                    <li>
                        <a href="https://www.facebook.com/stockxdotcom">
                            <svg class="stockx-icon " focusable="false" viewBox="0 0 44 44"
                                style="fill: var(--chakra-colors-text-primary, text-primary); color: var(--chakra-colors-text-primary, text-primary);">
                                <g>
                                    <path fill="currentColor"
                                        d="M44,22C44,9.85,34.15,0,22,0S0,9.85,0,22c0,10.98,8.05,20.08,18.56,21.73v-15.37h-5.59v-6.36h5.59v-4.85c0-5.51,3.28-8.56,8.31-8.56,2.41,0,4.92,.43,4.92,.43v5.41h-2.77c-2.73,0-3.59,1.7-3.59,3.44v4.13h6.1l-.98,6.36h-5.13v15.37c10.52-1.65,18.56-10.75,18.56-21.73Z">
                                    </path>
                                    <path
                                        d="M30.56,28.36l.98-6.36h-6.1v-4.13c0-1.74,.85-3.44,3.59-3.44h2.77v-5.41s-2.52-.43-4.92-.43c-5.03,0-8.31,3.05-8.31,8.56v4.85h-5.59v6.36h5.59v15.37c1.12,.18,2.27,.27,3.44,.27s2.32-.09,3.44-.27v-15.37h5.13Z"
                    ...
                    <li>
                        <a href="https://www.youtube.com/stockx">
                            <svg class="stockx-icon " focusable="false" viewBox="0 0 576 512"
                                style="fill: var(--chakra-colors-text-primary, text-primary); color: var(--chakra-colors-text-primary, text-primary);">
                                <path fill="currentColor"
        ...
        <div id="contenitore_footer_hidden">
            <div id="primo_div_hidden">
                <button class="bottone">
                    <svg class="stockx-icon " focusable="false" viewBox="0 0 35 35">
                        <path
                        ...
                        <path d="M18.27 4.90039H16.73V8.54039H18.27V4.90039Z" fill="currentColor"></path>
                        <path d="M18.27 26.5293H16.73V30.1693H18.27V26.5293Z" fill="currentColor"></path>
                        <path d="M11.8554 6.15383L10.5218 6.92383L12.3418 10.0761L13.6754 9.30607L11.8554 6.15383Z"
                            fill="currentColor"></path>
                        <path d="M22.6573 24.9234L21.3237 25.6934L23.1437 28.8456L24.4773 28.0756L22.6573 24.9234Z"
                            fill="currentColor"></path>
                        <path d="M6.95072 10.5414L6.18072 11.875L9.33296 13.695L10.103 12.3614L6.95072 10.5414Z"
                            fill="currentColor"></path>
                        <path d="M25.6312 21.3656L24.8612 22.6992L28.0134 24.5192L28.7834 23.1856L25.6312 21.3656Z"
                            fill="currentColor"></path>
                        <path d="M8.54 16.7305H4.9V18.2705H8.54V16.7305Z" fill="currentColor"></path>
                        <path d="M30.17 16.7305H26.53V18.2705H30.17V16.7305Z" fill="currentColor"></path>
                        <path d="M9.3058 21.3245L6.15356 23.1445L6.92356 24.4782L10.0758 22.6582L9.3058 21.3245Z"
                            fill="currentColor"></path>
                        <path d="M28.0755 10.5218L24.9233 12.3418L25.6933 13.6754L28.8455 11.8554L28.0755 10.5218Z"
                            fill="currentColor"></path>
                        <path d="M12.3 24.8614L10.48 28.0137L11.8137 28.7837L13.6337 25.6314L12.3 24.8614Z"
                            fill="currentColor"></path>
                        <path d="M23.1248 6.18175L21.3048 9.33398L22.6384 10.104L24.4584 6.95174L23.1248 6.18175Z"
                            fill="currentColor"></path>
                    </svg>
                </button>
                <div>
            ...
            <div id="secondo_div_hidden">
                <div id="menu_hidden">
                    <div class="custom_button">
                        ...
                        <svg class="stockx-icon chakra-icon css-1fzy3ki" focusable="false" viewBox="0 0 50 50">
                            <path fill="currentColor"
                    ...
                    <a class="android" href="https://play.google.com/store/apps/details?id=com.stockx.stockx&hl=en_US">
                        <svg viewBox="0 0 128 39" focusable="false" class="chakra-icon css-1e4lz4u">
                            <g clip-path="url(#clip0_2018_23135)">
                                <mask id="mask0_2018_23135" maskUnits="userSpaceOnUse" x="0" y="0" width="128"
                                    height="39" style="mask-type: luminance;">
                                    <path d="M127.53 0.470581H0.470703V38.1176H127.53V0.470581Z" fill="white"></path>
                                </mask>
                                <g mask="url(#mask0_2018_23135)">
                                    <path
                                        d="M122.824 38.1176H5.17659C2.63541 38.1176 0.470703 36.0471 0.470703 33.4118V5.17646C0.470703 2.54117 2.54129 0.470581 5.17659 0.470581H122.824C125.459 0.470581 127.53 2.54117 127.53 5.17646V33.4118C127.53 36.0471 125.365 38.1176 122.824 38.1176Z"
