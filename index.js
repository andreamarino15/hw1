...
function errorClick(event){
    ...
    alert('Devi prima registrarti per vedere gli articoli e salvarli nei preferiti');
}

const div = document.querySelector('.elementi');
div.addEventListener('click', errorClick);
