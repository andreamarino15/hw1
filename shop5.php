    ...
    <body>
        ...
        <section>
            <div id="contenitore_immagine">
                <img srcset="https://images.stockx.com/images/Bearbrick-Texalium-1000-Multi.png?fit=fill&bg=FFFFFF&w=576&h=384&q=60&dpr=1&trim=color&updated_at=1616760638 1x,
                https://images.stockx.com/images/Bearbrick-Texalium-1000-Multi.png?fit=fill&bg=FFFFFF&w=576&h=384&q=57&dpr=2&trim=color&updated_at=1616760638 2x,
                https://images.stockx.com/images/Bearbrick-Texalium-1000-Multi.png?fit=fill&bg=FFFFFF&w=576&h=384&q=41&dpr=3&trim=color&updated_at=1616760638 3x">
            </div>

            <div id="contenitore_generale">
                <div id="titolo">
                    <h1>
                        <span>Bearbrick Texalium 1000%</span>
                    ...
                    <span id="color">Multi</span>
                </div>
                <div id="contenitore_dati_scarpa">
                    <div id="scelta_immagine">
                        <button class="contenitore_immagine">
                            <img data-titolo="Bearbrick Texalium 1000%" data-color="Multi" data-prezzo="$3,524" src="https://images.stockx.com/images/Bearbrick-Texalium-1000-Multi.png?fit=fill&bg=FFFFFF&w=576&h=384&q=60&dpr=1&trim=color&updated_at=1616760638 1x,
                            https://images.stockx.com/images/Bearbrick-Texalium-1000-Multi.png?fit=fill&bg=FFFFFF&w=576&h=384&q=57&dpr=2&trim=color&updated_at=1616760638 2x,
                            https://images.stockx.com/images/Bearbrick-Texalium-1000-Multi.png?fit=fill&bg=FFFFFF&w=576&h=384&q=41&dpr=3&trim=color&updated_at=1616760638 3x">
                        </button>
                        <button class="contenitore_immagine">
